            ...
            <div className="flex relative items-center pb-12">
              ...
              <div className="flex-grow pl-4 grid grid-cols-3 items-center justify-center max-h-[320px] gap-6">
                <div className="items-start">
                  ...
                  <p>
                    A responsive portfolio showcasing my skills, projects, and
                    developer journey with sleek design and smooth animations.
                  </p>
                  <p>View Project</p>
                </div>
                  ...
                  <div className="grid gap-4 grid-cols-2 items-center justify-between">
                    <div>
                      <img
                        ...
                        src="https://i.ibb.co.com/Mg3y63m/room1.png"
                        alt=""
                      />
                    </div>
                    <div>
                      ...
                      <img
                        className="w-full h-full max-h-[300px]"
                        src="https://i.ibb.co.com/NpxC2sh/fluent1.png"
                        alt=""
                      />
                    </div>
                  </div>
            ...
            <div className="flex relative">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="text-lg font-jost text-dark-black/85 my-4 max-w-2xl">
                  ...
                  Gained foundational knowledge in subjects such as Physics,
                  Chemistry, Mathematics, Biology, etc. laying the groundwork
