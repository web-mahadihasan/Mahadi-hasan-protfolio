    ...
    return (
        <div>
            ...
            <section id="experience" className="max-w-7xl mx-auto px-4 xl:px-0 my-24">
                ...
                <p className="font-jost text-lg my-8 text-dark-black max-w-3xl">Embark on a journey through my professional growth, showcasing the skills, achievements, and milestones that define my career path.</p>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-16">
                    <div className="flex items-center justify-between p-6 experience-border-left relative">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl md:text-2xl my-2 font-rubik font-semibold text-white/90">Include Work</h3>
                                <p className="text-base font-medium text-dark-black font-jost">Web Recharger / Data Analyst</p>
                            </div>
                        </div>
                        <div>
                            <h5 className="text-lg md:text-xl tracking-wide my-2 font-rubik font-semibold text-white/90">1.3 Years</h5>
                    ...
                    <div className="flex items-center p-6 justify-between experience-border-right relative">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl md:text-2xl my-2 font-rubik font-semibold text-white/90">IIML</h3>
                                <p className="text-base font-medium text-dark-black font-jost">Data Analyst</p>
                            </div>
                        </div>
                        <div>
                            <h5 className="text-lg md:text-xl tracking-wide my-2 font-rubik font-semibold text-white/90">4.3 Years</h5>
