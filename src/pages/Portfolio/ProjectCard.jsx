    ...
    <div className="max-w-7xl mx-auto pt-10 px-4 xl:px-0">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center h-full lg:max-h-[500px] p-6 rounded-lg porfolioCarousel-shadow bg-[#1f242d]">
          ...
          <div className="space-y-6 order-2 md:order-1">
            ...
            <div className="flex items-center space-x-6">
              ...
              <a
                href={githubRepo}
                target="blank"
                className="w-12 h-12 flex items-center border border-main/15 justify-center bg-gray-800 text-green-400 rounded-full hover:bg-green-500 hover:text-white transition"
              >
                <FaGithub size={20} />
              </a>
            </div>
          ...
          <div
            className={`h-[400px] overflow-hidden rounded-lg group cursor-pointer order-1 md:order-2`}
          >
            {img && (
              <>
                <img
